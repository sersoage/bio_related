...
For a deep dive into the ULMFiT approach, model architectures, regularization and training strategies, see the [Methods Long Form](https://github.com/sersoage/bio_related/blob/master/Genomic/Methods/Methods%20Long%20Form.ipynb) document in the Methods section.

# Results
Performance of Genomic LM relative to other methods
...
Data generation described in [notebook](https://github.com/sersoage/bio_related/blob/master/Genomic/Bacteria/E.%20Coli/E.%20coli%200%20Data%20Processing.ipynb)

[Notebook Directory](https://github.com/sersoage/bio_related/blob/master/Genomic/Bacteria/E.%20Coli/)
...
[Notebook Directory](https://github.com/sersoage/bio_related/tree/master/Genomic/Mammals/Human/Promoter%20Classification%20Short%20Sequences/)
...
Data generation described in [notebook](https://github.com/sersoage/bio_related/blob/master/Genomic/Mammals/Human/Promoter%20Classification%20Long%20Sequences/Human%20Promoters%20Long%20Sequences%200%20Data%20Processing.ipynb)

[Notebook Directory](https://github.com/sersoage/bio_related/blob/master/Genomic/Mammals/Human/Promoter%20Classification%20Long%20Sequences/)
...
[Notebook Directory](https://github.com/sersoage/bio_related/tree/master/Genomic/Bacteria/Bacterial%20Ensemble/Promoter%20Classification)
...
[Notebook Directory](https://github.com/sersoage/bio_related/tree/master/Genomic/Bacteria/Bacterial%20Ensemble/Metagenomics%20Classification)
...
[Notebook Directory](https://github.com/sersoage/bio_related/tree/master/Genomic/Mammals/Mammal%20Ensemble/Enhancer%20Classification)
...
[Notebook Directory](hhttps://github.com/sersoage/bio_related/tree/master/Genomic/Mammals/Human/lncRNA%20Classification)


## Interpreting Results
One way to gain insight into how the classification model makes decisions is to perturb regions of a given input sequence to see how changing different regions of the sequence impact the classification result. This allows us to create plots like the one below, highlighting important sequence regions for classification. In the plot below, the red line corresponds to a true transcripotion start site. The plot shows how prediction results are sensitive to changes around that location. More detail on interpretations can be found in the [Model Interpretations](https://github.com/sersoage/bio_related/tree/master/Genomic/Model%20Interpretations) directory.

![](https://github.com/sersoage/bio_related/blob/master/Genomic/Model%20Interpretations/media/coli_interp.png)


## Long Sequence Inference
Inference on long, unlabeled sequences can be done by breaking the input sequence into chunks and plotting prediction results as a function of length. The image below shows a sample prediction of promoter locations on a 40,000 bp region of the E. coli genome. True promoter locations are shown in red. More detail can be found in this [notebook](https://github.com/sersoage/bio_related/blob/master/Genomic/Model%20Interpretations/Long%20Sequence%20Prediction%20E.%20coli.ipynb)

![](https://github.com/sersoage/bio_related/blob/master/Genomic/Model%20Interpretations/media/prediction_plot.png)
  
## Relevant Literature

For a comparison to other published methods, see Section 6 of the [Methods](https://github.com/sersoage/bio_related/blob/master/Genomic/Methods/Methods%20Long%20Form.ipynb) notebook. Here are some relevant papers in the deep genomics classification space.
